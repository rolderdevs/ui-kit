const tokens = {
  ...
  "colors.redApple.50": {
    "value": "#FFF3F3",
    "variable": "var(--colors-red-apple-50)"
  },
  "colors.redApple.100": {
    "value": "#FEE7E7",
    "variable": "var(--colors-red-apple-100)"
  },
  "colors.redApple.200": {
    "value": "#FEC5C5",
    "variable": "var(--colors-red-apple-200)"
  },
  "colors.redApple.300": {
    "value": "#FB8A89",
    "variable": "var(--colors-red-apple-300)"
  },
  "colors.redApple.400": {
    "value": "#F96D6C",
    "variable": "var(--colors-red-apple-400)"
  },
  "colors.redApple.500": {
    "value": "#F2423D",
    "variable": "var(--colors-red-apple-500)"
  },
  "colors.redApple.600": {
    "value": "#D82222",
    "variable": "var(--colors-red-apple-600)"
  },
  "colors.redApple.700": {
    "value": "#BA0C0C",
    "variable": "var(--colors-red-apple-700)"
  },
  "colors.redApple.800": {
    "value": "#8F0A0A",
    "variable": "var(--colors-red-apple-800)"
  },
  "colors.redApple.900": {
    "value": "#6E0808",
    "variable": "var(--colors-red-apple-900)"
  },
  "colors.orange.50": {
    "value": "#FFF4E3",
  ...
  "colors.mint.100": {
    "value": "#D6F5EB",
    "variable": "var(--colors-mint-100)"
  },
  "colors.mint.200": {
    "value": "#AEEAD7",
    "variable": "var(--colors-mint-200)"
  },
  "colors.mint.300": {
    "value": "#85E0C3",
    "variable": "var(--colors-mint-300)"
  },
  "colors.mint.400": {
    "value": "#5DD5AF",
    "variable": "var(--colors-mint-400)"
  },
  "colors.mint.500": {
    "value": "#01CEA2",
    "variable": "var(--colors-mint-500)"
  },
  "colors.mint.600": {
    "value": "#05A68D",
    "variable": "var(--colors-mint-600)"
  },
  "colors.mint.700": {
    "value": "#097C77",
    "variable": "var(--colors-mint-700)"
  },
  "colors.mint.800": {
    "value": "#075C59",
    "variable": "var(--colors-mint-800)"
  },
  "colors.mint.900": {
    "value": "#053A39",
    "variable": "var(--colors-mint-900)"
  },
  "colors.blue.50": {
    "value": "#E8F3FD",
  ...
  "shadows.default": {
    "value": "0px 0px 16px 0px rgba(0, 0, 0, 0.04), 0px 4px 24px 0px rgba(0, 0, 0, 0.08)",
    "variable": "var(--shadows-default)"
  },
  "shadows.low": {
    "value": "0px 0px 6px 0px rgba(0, 0, 0, 0.04), 0px 4px 16px 0px rgba(0, 0, 0, 0.08)",
    "variable": "var(--shadows-low)"
  },
  "shadows.upper": {
    "value": "0px -2px 24px 0px rgba(0, 0, 0, 0.08), 0px -8px 24px 0px rgba(0, 0, 0, 0.08)",
    "variable": "var(--shadows-upper)"
  },
  "radii.xl": {
    "value": "0.75rem",
  ...
  "colors.fg.secondary.muted": {
    ...
    "variable": "var(--colors-fg-secondary-muted)"
  },
  "colors.bg": {
    "value": "var(--colors-bg)",
  ...
  "colors.bg.bright": {
    "value": "var(--colors-bg-bright)",
    "variable": "var(--colors-bg-bright)"
  },
  "colors.bg.brighter": {
    "value": "var(--colors-bg-brighter)",
    "variable": "var(--colors-bg-brighter)"
  },
  "colors.text": {
  ...
  "colors.icon": {
    "value": "var(--colors-icon)",
    "variable": "var(--colors-icon)"
  },
  "colors.icon.muted": {
